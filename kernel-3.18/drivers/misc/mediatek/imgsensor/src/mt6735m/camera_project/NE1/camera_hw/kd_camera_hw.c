...
_kdCISModulePowerOn_exit_:
	...
	if(On){
		switch(pinSetIdx){
        case 0:	//main
			fih_bbs_camera_msg_by_addr(FIH_I2C_ADDR_S5K4H8_CAMERA, FIH_BBS_CAMERA_ERRORCODE_POWER_UP);
			break;
		case 1://front
		    fih_bbs_camera_msg_by_addr(FIH_I2C_ADDR_S5K4H8sub_CAMERA, FIH_BBS_CAMERA_ERRORCODE_POWER_UP);
			break;
		}
	}
	else{
		switch(pinSetIdx){
        case 0:	//main
			fih_bbs_camera_msg_by_addr(FIH_I2C_ADDR_S5K4H8_CAMERA, FIH_BBS_CAMERA_ERRORCODE_POWER_DW);
			break;
		case 1://front
		    fih_bbs_camera_msg_by_addr(FIH_I2C_ADDR_S5K4H8sub_CAMERA, FIH_BBS_CAMERA_ERRORCODE_POWER_DW);
			break;
		}
	}
	#endif
